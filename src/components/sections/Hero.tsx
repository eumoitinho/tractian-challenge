      ...
      <section className="relative w-full 3xl:min-h-[675px] 4xl:min-h-[695px]">
        ...
        <div className="relative z-10 flex w-full max-w-full justify-end bg-blue-950 bg-opacity-100 px-4 pb-12 pt-14 md:max-w-[50%] md:items-center md:bg-opacity-80 lg:px-12 lg:py-16 xl:py-20 xl:pl-16 xl:pr-24 3xl:min-h-[675px] 4xl:min-h-[695px]">
          <div className="flex w-full flex-col items-center gap-8 md:w-fit md:items-start">
            <article className="relative z-20 flex w-full flex-col items-center gap-4 md:items-start">
              <p className="text-center font-light text-white text-body-md md:text-center">{t("label")}</p>
            ...
            <button onClick={openDemoModal} className="max-w-fit rounded-sm w-full transition ease-in-out duration-150 disabled:cursor-not-allowed text-center bg-blue-600 text-white font-medium text-body-md px-4 py-2 bg-blue-600 hover:bg-blue-900 active:bg-blue-950 disabled:bg-slate-300 relative z-30 mx-auto flex items-center justify-center gap-2 md:mx-0">
        ...
        <div className="absolute inset-0 mx-auto hidden w-full items-center justify-end lg:flex 2xl:right-8 2xl:mr-0">
          <div className="flex w-full max-w-[240px] flex-col gap-4 rounded-l-sm bg-white px-4 py-4 lg:py-6 2xl:max-w-[280px] 2xl:rounded-sm 2xl:px-5 3xl:max-w-[320px] 3xl:px-6 3xl:py-7 4xl:max-w-[335px]">
            <p className="text-slate-500 text-body-sm 2xl:text-body-md 4xl:text-body-lg">{t("quote")}</p>
            <article className="flex w-full flex-col">
              <p className="text-[13px] font-bold 2xl:text-body-sm 4xl:text-body-md">{t("quoteAuthor")}</p>
              <p className="text-[13px] 2xl:text-body-sm 4xl:text-body-md">{t("quoteRole")}</p>
              <p className="text-[13px] font-bold 2xl:text-body-sm 4xl:text-body-md">{t("quoteCompany")}</p>
            </article>
          </div>
        </div>

        <div className="relative h-[340px] w-full sm:h-[290px] md:hidden">
