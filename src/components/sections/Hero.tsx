...
export function Hero() {
  ...
  return (
    <section
      className="bg-no-repeat bg-cover relative w-full h-[32.25rem] min-[2100px]:min-h-[42.19rem] min-[2460px]:min-h-[43.44rem]"
    ...
    >
      ...
      <div className="items-center bg-blue-950/[0.8] h-[32.25rem] justify-end pb-12 px-4 pt-14 relative w-full flex md:max-w-[50%] md:items-center lg:pl-12 lg:pr-12 lg:pt-16 lg:pb-16 xl:pt-20 xl:pb-20 xl:pl-16 xl:pr-24 min-[2100px]:min-h-[42.19rem] min-[2460px]:min-h-[43.44rem]">
        <div className="items-center flex-col w-full flex gap-8 md:w-fit md:items-start">
          ...
          <button onClick={openDemoModal} className="items-center bg-blue-600 text-white cursor-pointer font-medium h-10 justify-center max-w-fit py-2 px-4 relative text-center w-full flex rounded-sm gap-2 m-auto md:ml-0 md:mr-0">
            <p>{t("cta")}</p>
